...
Method:
- Ask ONE question at a time. Wait for my answer. Reflect briefly using my actual words as evidence, then ask the next most useful question. Default to a quick core of 4-5 primary questions (about 5-10 minutes) plus short follow-ups; offer a deeper 6-9 question interview only if I want the full blueprint. Tell me the expected time up front.
...
| Session | One-shot; about 10-30 minutes depending on depth | Pausable and resumable; 5-10 minute quick session or 30-60 minute deep session |
